        ...
        <div class="left" style="background: rgb(255, 182, 193, 0.7)">
          <div class="reservation_date">
            <div class="wage">
              ...
              <div>
                <h6 class="date_heading" id="date_heading" onclick="toggleDateInput()">{{\Carbon\Carbon::now()->format('d.m.Y')}}</h6>
                <input type="date" class="form-control hidden" id="date_input" onchange="dateInputChange()" />
              </div>
              <div>
      ...
      <div class="col-md-2 col-lg-2 col-xl-2 col-xxl-2">
        <div class="center" id="parent_res" style="background: rgb(144, 238, 144,0.8)">
          ...
          <div class="btn-group d-flex justify-content-between">
            <button type="button" class="btn btn-danger add_style_btn active" style="text-transform: capitalize!important" data-bs-toggle="modal" data-bs-target="#EmployeeAttendenceModal" >
              Mitarbeiter
            </button>

            @if(Session::has('lock'))
            <button id="logoutsessionbutton" style="border-radius:0;border-top-right-radius:0px!important;background-color: black" class="btn btn-dark py-2 px-3 fs-5">
              <i class="fas fa-sign-out"></i>
            </button>
            @else
            <button id="restrictedAccessBtn" style="border-radius:0;border-top-right-radius:0px!important;background-color: black" class="btn btn-dark py-2 px-3 fs-5" data-bs-toggle="modal" data-bs-target="#pinModal">
          ...
          <a href="{{route('admin.dogs.in.rooms')}}" class="add_style_btn active" style="border-radius: 0!important">
            Mehrfachkasse &nbsp;
            <i class="fa fa-external-link"></i>
          </a>

          <div class="btn-group d-flex justify-content-between">
            <button type="button" class="btn btn-danger add_style_btn active text-capitalize" style="border-radius: 0!important" onclick="openXimmerModal()">
              Zimmer
            </button>
          </div>
                  ...
                  <div class="reservations-date-section">
                      ...
                      <div class="items dogItems mt-2">
                          @foreach($reservationsForDate as $obj)
                              @if(isset($obj->dog))
                                  <div class="" id="child_{{$obj->dog->id}}" data-res-id="{{$obj->id}}" data-position='left'>
                                      <div class="item card mb-2">
                                          <div class="card-body space-nill bg-extralight bg-success-500 }}">
                                              <div class="flex justify-between">
                                                  <p>ID{{str_pad($obj->dog->id, 3, '0', STR_PAD_LEFT)}}</p>
                                                  <p>{{$obj->stays}}</p>
                                              </div>
                                          </div>
                                          <div class="card-header portlet-header">
                                              <div class="flex justify-between align-items-center">
                                                  <div class="flex align-items-center">
                                                      <a href="uploads/users/dogs/{{$obj->dog->picture}}" target="_blank">
                                                          <img src="uploads/users/dogs/{{$obj->dog->picture}}" class="img-fluid" alt="Dog" />
                                                      </a>
                                                      <h3 class="name">{{$obj->dog->name}}</h3>
                                                  </div>
                                                  <div>
                                                      <button class="no-style text-danger deleteResCross" onclick="deleteReservation('{{$obj->id}}')">
                                                          <i class="mdi mdi-close-circle-outline big-icon"></i>
                                                      </button>
                                                      <button class="no-style text-dark hiddenInfo" onclick="dogInfo('{{$obj->id}}')">
                                          ...
                                          <div class="card-body space-nill">
                                              <p class="pb-1">
                                                  <a href="{{route('admin.customers.preview', ['id'=>$obj->dog->customer->id])}}" target="_blank">{{$obj->dog->customer->name}} ({{$obj->dog->customer->id_number}})</a>
                                              </p>
                                              <hr class="p-0 m-0">
                                              @php
                                              ...
                                              <div class="flex justify-between py-2">
                                                  ...
                                                  <p class="text-success">{{number_format($obj->totalAmount, 2)}}&euro;</p>
                                                  @else
                                                  <p class="text-danger">{{number_format($obj->totalAmount, 2)}}&euro;</p>
                                                  @endif
                                              </div>
                                              <hr class="p-0 m-0">
                                          ...
                                          <div class="card-body space-nill bg-extralight iconsLists">
                                              <div class="flex justify-between">
                                                  <ul>
                                                      <li>
                                                          <button class="no-style" title="In ein anderes Zimmer verschieben" onclick="moveFromRes('{{$obj->dog->id}}', {{$obj->id}})">
                                                  ...
                                                  <ul>
                                                      ...
                                                      <li>
                                                          <button class="no-style" title="V" data-toggle="tooltip">
                                                              <i class="fa fa-check fs25"></i>
                                                          </button>
                                                      </li>
                                                      @elseif($obj->dog->compatibility == 'VJ')
                                                      <li>
                                                          <button class="no-style" title="VJ" data-toggle="tooltip">
                                                              <span class="tbspan nb">nB</span>
                                                          </button>
                                                      </li>
                                                      @elseif($obj->dog->compatibility == 'VM')
                                                      <li>
                                                          <button class="no-style" title="VM" data-toggle="tooltip">
                                                              <span class="tbspan nm">nM</span>
                                                          </button>
                                                      </li>
                                                      @elseif($obj->dog->compatibility == 'UV')
                                                      <li>
                                                          <button class="no-style" title="UV" data-toggle="tooltip">
                                                              <i class="fa fa-times text-danger fs25"></i>
                                                          </button>
                                                      </li>
                                                      @elseif($obj->dog->compatibility == 'S')
                                                      <li>
                                                          <button class="no-style" title="S" data-toggle="tooltip">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- PIN Input Field -->
                    <input type="password" id="pin" class="form-control" maxlength="4" placeholder="Geben Sie die 4-stellige PIN ein" />
                    <div class="text-danger" id="pinError" style="display: none;">Ungültige PIN, bitte versuchen Sie es erneut.</div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal" aria-label="Close" >schließen</button>
      ...
      <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8">
        <div class="right">
          <div class="rooms reservationBox scrumboard">
            ...
            <div class="room card mb-2" id="parent_{{$obj->id}}" style="position: relative;z-index: 1;">
              <div class="card-header">
                <div class="flex justify-between">
                  ...
                  <div class="flex align-items-center" style="margin-top: -15px">
                    <div>
                      <span class="badge bg-primary rounded"><span class="count">{{count($obj->reservations)}}</span>/{{$obj->capacity}}</span>
                    </div>
                    <div>
                      <button class="no-style" style="color: #5a5fe0" onclick="dogsInRoom('{{$obj->id}}')">
                        <i class="mdi mdi-plus-box-multiple-outline big-icon"></i>
                      </button>
                    </div>
                  </div>
              ...
              <div class="card-body px-1">
                <div class="row dogItems rright" style="min-height: 40px;">
                  ...
                  @endphp
                  <div class="col-md-4 col-lg-4 col-xl-4 col-xxl-3 child" id="child_{{$item->dog_id}}" data-res-id="{{$item->id}}">
                    <div class="item card mb-2 portlet-header">
                      @php
                        $color = 'bg-warning';
                      ...
                      @endphp
                      <div class="card-body space-nill bg-extralight {{ $color }}">
                        <div class="flex justify-between">
                      ...
                      <div class="card-header">
                        <div class="flex justify-between align-items-center">
                          <div class="flex align-items-center">
                            <a href="uploads/users/dogs/{{$item->dog->picture}}" target="_blank">
                              <img src="uploads/users/dogs/{{$item->dog->picture}}" class="img-fluid" alt="Dog" />
                            </a>
                            <div>
                              <h3 class="name">{{$item->dog->name}}</h3>
                              @if($item->totalAmount > 0)
                              <p class="text-success bjty">{{number_format($item->totalAmount, 2)}}&euro;</p>
                              @else
                              <p class="text-danger bjty">{{number_format($item->totalAmount, 2)}}&euro;</p>
                              @endif
                            </div>
                          </div>

                          <div class="flexerf">
                            <button class="no-style text-dark dogInfoBtn" onclick="dogInfo('{{$item->id}}')">
                      ...
                      <div class="card-body space-nill p-0 m-0">
                        <p class="pb-1 px-2 py-2">
                          <a href="{{route('admin.customers.preview', ['id' => $item->dog->customer->id])}}">{{$item->dog->customer->name}} ({{$item->dog->customer->id_number}})</a>
                        </p>
                        <hr class="p-0 m-0">
                        @php
                        ...
                        <div class="flex justify-between py-2 px-2">
                          <p class="tag">{{$days_between}} Tage - {{ ($item->dog->neutered == 1) ? 'K' : 'NK' }}</p>
                      ...
                      <div class="card-body space-nill iconsLists">
                        <div class="flex justify-between">
                          <ul>
                            <li>
                              <button class="no-style" data-toggle="tooltip" title="In ein anderes Zimmer verschieben" onclick="moveDog('{{$item->dog_id}}', '{{$item->id}}')">
                                <i class="mdi mdi-cursor-move"></i>
                              </button>
                            </li>
                            {{-- @if(isset($item->plan) && $item->plan != null) --}}
                            <li>
                              <button class="no-style" data-toggle="tooltip" title="Kasse" onclick="checkoutModal('{{$item->id}}', '{{$item->checkin_date}}', '{{isset($item->plan_id) ? $item->plan_id : false}}','{{ isset($item->plan) ? $item->plan->price : 0 }}')">
                          ...
                          <ul>
                            ...
                            <li>
                              <button class="no-style" title="Wassergräber" data-toggle="tooltip">
                            ...
                            @if($item->dog->is_allergy == 1)
                                <li>
                                    <button class="no-style" data-toggle="tooltip" title="<?php echo $item->dog->allergy; ?>">
                                        <span style="font-weight: bold; color: green; font-size: 17px; line-height: 1; position: relative; top: 2px;">A</span>
                                    </button>
                                </li>
                            @endif
                            ...
                            <li>
                              <button class="no-style" data-toggle="tooltip" title="Morgen(<?php echo $item->dog->morgen; ?>) -Mittag(<?php echo $item->dog->mittag; ?>)-Abend(<?php echo $item->dog->abend; ?>)">
                            ...
                            <li>
                              <button class="no-style" style="color: green;" title="V" data-toggle="tooltip">
                                <i class="mdi mdi-check-circle"></i>
                              </button>
                            </li>
                            @elseif($item->dog->compatibility == 'UV')
                            <li>
                              <button class="no-style" style="color: red;" title="UV" data-toggle="tooltip">
                                <i class="mdi mdi-close"style="transform: scale(1.4); display: inline-block;"></i>
                              </button>
                            </li>
                            @elseif($item->dog->compatibility == 'VJ')
                            <li>
                              <button class="no-style" style="" title="nB" data-toggle="tooltip">
                            ...
                            <li>
                              <button class="no-style" title="nM" data-toggle="tooltip">
                                <span class="tbspan nm">nM</span>
                              </button>
                            </li>
...
{{-- Modal Area Starts Here --}}
    ...
    <div class="modal-dialog modal-lg modal-simple modal-enable-otp modal-dialog-centered">
      <div class="modal-content p-3 p-md-5">
        <div class="modal-body p-md-0">
          ...
          <form action="{{route('admin.reservation.add')}}" method="POST" enctype="multipart/form-data" id="addReservationForm">
            @csrf
            <div class="row">
                <div class="col-md-12">
                    <div class="form-floating form-floating-outline mb-4 baris">
                        <select name="dog_ids[]" id="dog_id" class="select2" data-placeholder='Wählen Sie Hunde aus' data-live-search="true" required>
                          <option selected disabled>Hund auswählen</option>
                          @foreach($dogs as $dog)
                              <option value="{{$dog->id}}">{{$dog->name}} @if($dog->compatible_breed)({{$dog->compatible_breed}})@endif - {{isset($dog->customer) ? $dog->customer->name : ''}} ({{ isset($dog->customer) ? $dog->customer->phone : '' }})</option>
                          @endforeach
                        </select>
          ...
          <form class="row g-3" method="POST" action="{{route('admin.todo.add')}}">
            ...
            <div class="col-md-12">
              <div class="form-floating form-floating-outline mb-2">
                  <textarea required class="form-control" name="task" id="task" style="height: 90px"></textarea>
              </div>
          </div>
            <div class="col-12">
  ...
  <div class="modal fade" id="EmployeeAttendenceModal" tabindex="-1" aria-labelledby="usersModalLabel" aria-hidden="true">
                    ...
                    <div class="d-flex justify-content-end">
                      <div>
                        <a href="javascript:void(0);">
                          <button id="bin_da_{{ $obj->id }}" class="btn btn-success btn-sm" onclick="createEventRecord({{ $obj->id }})">
                            Bin Da
                          </button>
                        </a>

                        <a href="javascript:void(0);">
                          <button id="bin_fort_{{ $obj->id }}" class="btn btn-danger btn-sm" onclick="endEventRecord({{ $obj->id }})" disabled>
                            Bin Fort
                          </button>
                        </a>
    ...
    <div class="modal-dialog modal-simple modal-enable-otp modal-dialog-centered modal-lg">
      <div class="modal-content p-3 p-md-5">
        <div class="modal-body p-md-0">
          ...
          <hr style="border-color: grey">
          <form action="{{route('admin.reservation.dashboard')}}" method="POST" enctype="multipart/form-data" id="addReservationForm2">
            @csrf
            <div class="row">
                <div class="col-md-12">
                    <div class="form-floating form-floating-outline mb-4 baris">
                        <select name="dog_id" id="id_dog" class="select2" data-live-search="true" required onchange="searchDogPlan(this.value)">
                          <option selected disabled>Hund auswählen</option>
                          @foreach($dogs as $dog)
                            <option value="{{$dog->id}}">{{$dog->name}} @if($dog->compatible_breed)({{$dog->compatible_breed}})@endif - {{isset($dog->customer) ? $dog->customer->name : ''}} ({{isset($dog->customer) ? $dog->customer->phone : ''}})</option>
                          @endforeach
                ...
                <div class="col-md-12">
                  <div class="form-floating form-floating-outline mb-4">
                      <select name="plan_id" id="plan_id" class="select2" data-live-search="true" required autofocus>
    ...
    <div class="modal-content p-3 p-md-5">
        <div class="modal-body p-md-0">
            ...
            <div class="d-flex justify-content-center">
                <button type="button" class="btn btn-danger fs-4" id="resetButton" style="padding: 6px 12px; border-radius: 5px;">
                    Neue Seite
                </button>
            </div>
            <hr>
      ...
      <div class="modal-content p-3 p-md-5">
        <div class="modal-body p-md-0">
          <div class="d-flex justify-content-between">
            <div class="d-flex align-items-center">
              ...
              <div>
                ...
                <span id="separator" class="fs-3 fw-bold text-black ms-3" style="display: none;">-</span>
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              <table class="table table-striped text-cente infoModalHabitsTable" style="width: 100%; margin-left:0;">
                <thead>
                    <tr>
                        <th></th>
              ...
              <h4 class="text-start mx-3 mt-3 mb-4">Kunde: <span id="customer_name" class="fs-4" style="text-decoration: underline; color:#0053ac"></span></h4>
              ...
              <div class="table-responsive">
                <table class="table table-striped dogInfoTable" id="hundeFriends">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <img src="uploads/users/dogs/1714434169360_F_602743936_qbTuk7bb34cSYBgSDbsirlmJSbxRBUFM.jpg" width="120" class="rounded img-fluid" alt="Friend Picture" />
                      </td>
                      <td></td>
                      <td></td>
                      <td>
            ...
            <div class="col-md-4">
              {{-- Checkin/Checkout --}}
              <div class="form-floating form-floating-outline mb-2">
                <input type="text" id="rangepicker" name="dates[]" class="form-control bludate bs-rangepicker-basic" required/>
                <label for="rangepicker">Einchecken - Auschecken</label>
              </div>
              <input type="hidden" id="flatpickr-range" class="hidden" />
              ...
              <div class="d-flex justify-content-end">
                <button type="submit" class="btn btn-primary mt-2" id="submitNote">Aktualisieren</button>
              </div>
              {{-- Dog Friends Area --}}
            </div>
          </div>
        ...
        <div class="modal-body p-md-0">
          ...
          <form action="{{route('admin.reservation.checkout')}}" method="POST">
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                  <div class="form-floating form-floating-outline mb-4">
                      <select name="price_plan" id="price_plan" class="select2" data-live-search="true" required>
                        @foreach($plans as $obj)
                            <option value="{{$obj->id}}"><?php echo $obj->title; ?></option>
                        @endforeach
                      </select>
              ...
              <div class="col-md-12">
                <div class="form-floating form-floating-outline mb-4">
                    <select name="gateway" id="gateway" class="select2" data-live-search="true" required>
              ...
              <div class="col-md-12">
                <div class="d-flex justify-space-between">
                  ...
                  <div class="form-check ms-5">
                    <input name="discount" class="form-check-input" type="radio" value="0" id="discount1" checked/>
                    <label class="form-check-label" for="discount1"> 0% </label>
                  </div>
                  <div class="form-check mx-4">
                    <input name="discount" class="form-check-input" type="radio" value="10" id="discount2" />
                    <label class="form-check-label" for="discount2"> 10% </label>
                  </div>
                  <div class="form-check">
                    <input name="discount" class="form-check-input" type="radio" value="15" id="discount3" />
              ...
              <div class="col-md-12 mt-3">
                <div class="form-floating form-floating-outline mb-4">
                    <input type="number" id="cost" class="form-control text-primary" value="330.00" disabled />
                    <label for="gateway">Aktueller Preis (&euro;)</label>
                </div>
              </div>
              <div class="col-md-12">
                <div class="form-floating form-floating-outline mb-4">
                    <input type="number" name="total" step="0.10" id="total_amount" class="form-control text-primary absInput" value="330.00" />
                    <label for="total_amount">Rechnungsbetrag (&euro;)</label>
                </div>
              </div>
              <div class="col-md-12">
                <div class="form-floating form-floating-outline mb-4">
                    <input type="number" name="received_amount" step="0.10" id="received_amount" class="form-control text-primary absInput" value="330.00" />
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Schließen"></button> <!-- Close -->
        </div>
        <div class="modal-body">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Schließen</button> <!-- Close -->
        </div>
      </div>
    </div>
  </div>
  ...
  $('#logoutsessionbutton').click(function() {
    ...
    $(".dogItems").sortable({
        ...
        start: function(event, ui) {
          ...
          ui.helper.css({
              'z-index': 9999,
              'position': 'relative' // Ensure the element is positioned relative or absolute
          });
