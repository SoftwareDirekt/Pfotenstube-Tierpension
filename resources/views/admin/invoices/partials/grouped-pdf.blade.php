...
<body>
    <div class="invoice-wrapper">
        ...
        <table class="items-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $item['days'] }}</td>
                    <td>€{{ number_format($item['plan_cost'], 2, ',', '.') }}</td>
                    <td>€{{ number_format($item['special_cost'], 2, ',', '.') }}</td>
                    <td>
                        @if($item['discount_percentage'] > 0)
                        {{ number_format($item['discount_percentage'], 0) }}%<br>
        ...
        <table class="totals-table">
            <tr>
                <td class="label">Netto ({{ $reservation_count }} {{ $reservation_count == 1 ? 'Reservierung' : 'Reservierungen' }})</td>
                <td class="value">€{{ number_format($totals['net'], 2, ',', '.') }}</td>
            </tr>
            <tr>
                <td class="label">MwSt ({{ number_format($vat_percentage, 0) }}% von €{{ number_format($totals['net'], 2, ',', '.') }})</td>
